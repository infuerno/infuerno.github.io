...
- This project uses three [Eleventy Layouts](https://www.11ty.dev/docs/layouts/):
  ...
  - `_includes/layouts/page.njk`: the regular page template (wrapped into `base.njk`)
  - `_includes/layouts/post.njk`: the blog style post template (wrapped into `base.njk`)
